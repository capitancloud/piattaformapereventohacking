...
export const trafficScenario: Scenario = {
  ...
  tasks: [
    ...
    },
    {
      ...
      details:
        "Non serve il punteggio perfetto: se sbagli, torna al task corrispondente e rileggi la spiegazione. Il quiz copre tutto quello che abbiamo visto: dagli strati di un pacchetto agli strumenti da riga di comando.\n\nBuon lavoro!\n\nPrima di completare l’attività, usa questo obiettivo come domanda guida: consolidare le basi di analisi del traffico. Non cercare di leggere tutti i pacchetti insieme: parti da sorgente, destinazione e protocollo, poi approfondisci soltanto i dettagli utili. Confronta sempre ciò che osservi con il comportamento normale che ti aspetteresti. In questo modo sarà più semplice distinguere un problema tecnico, un’attività legittima e un possibile segnale di attacco.",
