...
export const startHereScenario: Scenario = {
  ...
  tasks: [
    ...
    },
    {
      ...
      details:"Non è un esame, è una checklist mentale. Se qualche risposta ti fa dubitare, torna sui task corrispondenti: sono lì apposta. Le domande alternano etica, metodologia e strumenti: sono le tre gambe su cui poggia tutto il resto del percorso.",
