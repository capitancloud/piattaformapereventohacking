  ...
  tasks: [
    {
      ...
      details:
        "PowerShell è il linguaggio nativo di amministrazione di Windows. Ogni comando ha la forma Verbo-Nome (Get-Date, Write-Host, Set-ItemProperty). Le variabili iniziano con $. I commenti iniziano con #. Sono le tre cose che ti servono per non essere in balia dello script sospetto del prossimo task.",
    ...
    },
    {
      ...
      details:
        "Nel triage iniziale non serve capire tutto: serve decidere se lo script va analizzato a fondo. Gli indicatori tipici di uno script malevolo sono: -EncodedCommand con blob Base64 lungo, -WindowStyle Hidden, -ExecutionPolicy Bypass, richieste di rete a IP grezzi, uso di Invoke-Expression o Net.WebClient.",
    ...
    },
    {
      ...
      details:
        "PowerShell usa -EncodedCommand per accettare comandi da riga di comando senza problemi di escaping. La codifica attesa è Base64 di una stringa UTF-16 Little Endian. Se decodifichi come ASCII vedrai testo strappato: è normale, e conferma che stai guardando -EncodedCommand.",
    ...
    },
    {
      ...
      details:
        "PowerShell risolve una variabile che contiene 'Invoke-Expression' esattamente come il nome scritto per intero. È tutto ciò che serve per rendere invisibile a un pattern-matcher ingenuo la parte più tipica di uno script malevolo.",
    ...
    },
    {
      ...
      details:
        "In PowerShell [char[]](73,110,...) trasforma una lista di numeri in un array di caratteri, poi -join '' li unisce. Bastano un paio di clic per farlo in JavaScript, Python, o a mano.",
    ...
    },
    {
      ...
      details:
        "XOR con chiave singola è pigro: bastano ~127 tentativi per decifrarlo, o zero se conosci un pezzo del testo in chiaro (in questo caso l'URL inizia sicuramente con http://). Nonostante questo, si vede ancora in molti sample.",
    ...
    },
    {
      ...
      details:
        "Un prompt di analisi malware efficace chiede tre cose: (1) cosa fa lo script passo per passo, (2) quali IoC lascia (registro, file, rete), (3) quali contromisure applicare. Domande vaghe come 'è pericoloso?' portano a risposte vaghe.",
    ...
    },
    {
      ...
      details:
        "La disciplina del reverse engineering è ferrea: si riporta ciò che il codice fa, non ciò che il codice 'potrebbe' fare. Aggiungere comportamenti non dimostrati porta a IoC sbagliati e a incident report che perdono credibilità.",
    ...
    },
    {
      ...
      details:
        "Uno script di remediation buono è idempotente (puoi lanciarlo N volte senza effetti collaterali), silenzioso in caso di 'niente da fare' (-ErrorAction SilentlyContinue) e chirurgico (tocca solo ciò che il malware ha creato).",
